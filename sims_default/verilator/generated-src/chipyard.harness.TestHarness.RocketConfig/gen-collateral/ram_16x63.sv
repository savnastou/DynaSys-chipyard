...
module ram_16x63(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [62:0] R0_data,
  ...
  reg [62:0] Memory[0:15];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM[62:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 63'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
