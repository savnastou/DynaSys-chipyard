...
module HellaCacheArbiter(
  ...
  always @(posedge clock) begin
    s1_id <= ~io_requestor_0_req_valid;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:20:20, :34:35, :36:15, :51:26]
  ...
  assign io_requestor_0_s2_nack = io_mem_s2_nack & ~s2_id;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:21:24, :53:21, :68:49]
  assign io_requestor_0_resp_valid = io_mem_resp_valid & ~(io_mem_resp_bits_tag[0]);	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:61:{41,57}, :62:39]
  ...
  assign io_requestor_1_s2_nack = io_mem_s2_nack & s2_id;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:21:24, :68:49]
  assign io_requestor_1_resp_valid = io_mem_resp_valid & io_mem_resp_bits_tag[0];	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:61:41, :62:39]
  assign io_requestor_1_resp_bits_tag = {1'h0, io_mem_resp_bits_tag[6:1]};	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:74:{21,45}]
  ...
  assign io_mem_req_bits_addr = io_requestor_0_req_valid ? io_requestor_0_req_bits_addr : io_requestor_1_req_bits_addr;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:33:25, :51:26]
  assign io_mem_req_bits_tag = io_requestor_0_req_valid ? 7'h0 : {io_requestor_1_req_bits_tag[5:0], 1'h1};	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :34:29, :51:26]
  assign io_mem_req_bits_cmd = io_requestor_0_req_valid ? 5'h0 : io_requestor_1_req_bits_cmd;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :33:25, :51:26]
  assign io_mem_req_bits_size = io_requestor_0_req_valid ? 2'h3 : io_requestor_1_req_bits_size;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :33:25, :51:26]
  assign io_mem_req_bits_signed = ~io_requestor_0_req_valid & io_requestor_1_req_bits_signed;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:33:25, :51:26]
  assign io_mem_req_bits_dprv = io_requestor_0_req_valid ? 2'h1 : io_requestor_1_req_bits_dprv;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :33:25, :51:26]
  assign io_mem_req_bits_phys = io_requestor_0_req_valid;
  assign io_mem_s1_kill = s1_id ? io_requestor_1_s1_kill : io_requestor_0_s1_kill;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:20:20, :39:24, :52:30]
  assign io_mem_s1_data_data = s1_id ? io_requestor_1_s1_data_data : 64'h0;	// @[generators/rocket-chip/src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :20:20, :33:25, :40:24, :51:26, :52:30]
endmodule
