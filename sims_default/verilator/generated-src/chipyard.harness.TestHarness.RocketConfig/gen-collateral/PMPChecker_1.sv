...
module PMPChecker_1(
  ...
  wire res_hit = io_pmp_7_cfg_a[1] ? ((io_addr ^ {io_pmp_7_addr, 2'h0}) & ~io_pmp_7_mask) == 32'h0 : io_pmp_7_cfg_a[0] & io_addr >= {io_pmp_6_addr, 2'h0} & io_addr < {io_pmp_7_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore = io_prv[1] & ~io_pmp_7_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_1 = io_pmp_6_cfg_a[1] ? ((io_addr ^ {io_pmp_6_addr, 2'h0}) & ~io_pmp_6_mask) == 32'h0 : io_pmp_6_cfg_a[0] & io_addr >= {io_pmp_5_addr, 2'h0} & io_addr < {io_pmp_6_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore_1 = io_prv[1] & ~io_pmp_6_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_2 = io_pmp_5_cfg_a[1] ? ((io_addr ^ {io_pmp_5_addr, 2'h0}) & ~io_pmp_5_mask) == 32'h0 : io_pmp_5_cfg_a[0] & io_addr >= {io_pmp_4_addr, 2'h0} & io_addr < {io_pmp_5_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore_2 = io_prv[1] & ~io_pmp_5_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_3 = io_pmp_4_cfg_a[1] ? ((io_addr ^ {io_pmp_4_addr, 2'h0}) & ~io_pmp_4_mask) == 32'h0 : io_pmp_4_cfg_a[0] & io_addr >= {io_pmp_3_addr, 2'h0} & io_addr < {io_pmp_4_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore_3 = io_prv[1] & ~io_pmp_4_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_4 = io_pmp_3_cfg_a[1] ? ((io_addr ^ {io_pmp_3_addr, 2'h0}) & ~io_pmp_3_mask) == 32'h0 : io_pmp_3_cfg_a[0] & io_addr >= {io_pmp_2_addr, 2'h0} & io_addr < {io_pmp_3_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore_4 = io_prv[1] & ~io_pmp_3_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_5 = io_pmp_2_cfg_a[1] ? ((io_addr ^ {io_pmp_2_addr, 2'h0}) & ~io_pmp_2_mask) == 32'h0 : io_pmp_2_cfg_a[0] & io_addr >= {io_pmp_1_addr, 2'h0} & io_addr < {io_pmp_2_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore_5 = io_prv[1] & ~io_pmp_2_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_6 = io_pmp_1_cfg_a[1] ? ((io_addr ^ {io_pmp_1_addr, 2'h0}) & ~io_pmp_1_mask) == 32'h0 : io_pmp_1_cfg_a[0] & io_addr >= {io_pmp_0_addr, 2'h0} & io_addr < {io_pmp_1_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
  wire res_ignore_6 = io_prv[1] & ~io_pmp_1_cfg_l;	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:155:56, :163:{26,29}]
  wire res_hit_7 = io_pmp_0_cfg_a[1] ? ((io_addr ^ {io_pmp_0_addr, 2'h0}) & ~io_pmp_0_mask) == 32'h0 : io_pmp_0_cfg_a[0] & io_addr < {io_pmp_0_addr, 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :46:26, :60:{36,48}, :63:{47,52,54,58}, :77:9, :132:{8,61}]
