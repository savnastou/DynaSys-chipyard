...
module Queue_55(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram_sink = _RANDOM[/*Zero width*/ 1'b0][3:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_sink = ram_sink;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
