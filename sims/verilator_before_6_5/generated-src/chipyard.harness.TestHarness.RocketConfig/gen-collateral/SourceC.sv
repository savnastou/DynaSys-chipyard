...
module SourceC(
  ...
  input  [2:0]  io_req_bits_opcode,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
                ...
                io_req_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  output [2:0]  io_c_bits_opcode,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
                ...
                io_c_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_source = _RANDOM[2'h0][17:15];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_tag = _RANDOM[2'h0][30:18];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_set = {_RANDOM[2'h0][31], _RANDOM[2'h1][8:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_way = _RANDOM[2'h1][11:9];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
        s2_valid = _RANDOM[2'h1][13];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :97:25]
        s2_req_opcode = _RANDOM[2'h1][16:14];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_param = _RANDOM[2'h1][19:17];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_source = _RANDOM[2'h1][22:20];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_tag = {_RANDOM[2'h1][31:23], _RANDOM[2'h2][3:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_set = _RANDOM[2'h2][13:4];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
        s3_valid = _RANDOM[2'h2][22];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :103:25]
        s3_req_opcode = _RANDOM[2'h2][25:23];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_param = _RANDOM[2'h2][28:26];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_source = _RANDOM[2'h2][31:29];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_tag = _RANDOM[2'h3][12:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
        s3_req_set = _RANDOM[2'h3][22:13];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_41 queue (	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
