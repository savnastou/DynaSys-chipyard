...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__3049(VTestDriver___024root* vlSelf) {
    ...
    if (((0U != (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__tile_prci_domain__DOT__element_reset_domain_rockettile__DOT__atomAddressMap__DOT__pref__DOT__prq__DOT__head)) 
         & (~ (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__tile_prci_domain__DOT__element_reset_domain_rockettile__DOT__atomAddressMap__DOT__pref__DOT__upcoming_exists)))) {
