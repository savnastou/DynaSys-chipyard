...
module TLRAM(
  ...
  input  [10:0] auto_in_a_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  output [10:0] auto_in_d_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:367:18]
  ...
  reg  [10:0] r_source;	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:125:26]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_full = _RANDOM[4'h5][29];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:121:30]
        r_size = _RANDOM[4'h6][5:4];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26]
        r_source = _RANDOM[4'h6][16:6];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26, :125:26]
        r_read = _RANDOM[4'h6][17];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:124:26, :126:26]
        REG = _RANDOM[4'h9][26];	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58]
        r_0 = {_RANDOM[4'h9][31:27], _RANDOM[4'hA][2:0]};	// @[generators/rocket-chip/src/main/scala/tilelink/SRAM.scala:308:58, generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_1 = _RANDOM[4'hA][10:3];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_2 = _RANDOM[4'hA][18:11];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_3 = _RANDOM[4'hA][26:19];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_4 = {_RANDOM[4'hA][31:27], _RANDOM[4'hB][2:0]};	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_5 = _RANDOM[4'hB][10:3];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_6 = _RANDOM[4'hB][18:11];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        r_7 = _RANDOM[4'hB][26:19];	// @[generators/rocket-chip/src/main/scala/util/package.scala:80:63]
      `endif // RANDOMIZE_REG_INIT
    end // initial
