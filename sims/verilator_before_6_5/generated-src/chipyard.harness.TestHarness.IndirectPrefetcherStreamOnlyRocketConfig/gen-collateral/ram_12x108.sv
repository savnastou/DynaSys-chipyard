...
module ram_12x108(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [3:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [107:0] Memory[0:11];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [3:0] i = 4'h0; i < 4'hC; i += 4'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[107:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 108'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
