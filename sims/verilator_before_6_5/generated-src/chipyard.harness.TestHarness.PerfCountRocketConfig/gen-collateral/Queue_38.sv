...
module Queue_38(
  ...
  assign io_deq_bits_id = full ? ram[3:0] : io_enq_bits_id;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_addr = full ? ram[35:4] : io_enq_bits_addr;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_len = full ? ram[43:36] : io_enq_bits_len;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_size = full ? ram[46:44] : io_enq_bits_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_burst = full ? ram[48:47] : 2'h1;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_lock = full & ram[49];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_cache = full ? ram[53:50] : 4'h0;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_prot = full ? ram[56:54] : 3'h1;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_qos = full ? ram[60:57] : 4'h0;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_echo_tl_state_size = full ? ram[64:61] : io_enq_bits_echo_tl_state_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_echo_tl_state_source = full ? ram[68:65] : io_enq_bits_echo_tl_state_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_wen = full ? ram[69] : io_enq_bits_wen;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
endmodule
