...
module Repeater(
  ...
  input  [63:0]  io_enq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input  [511:0] io_enq_bits_data,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [63:0]  io_deq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output [511:0] io_deq_bits_data,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  reg  [63:0]  saved_mask;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg  [511:0] saved_data;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        full = _RANDOM[5'h0][0];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21]
        saved_opcode = _RANDOM[5'h0][3:1];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_param = _RANDOM[5'h0][6:4];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_size = _RANDOM[5'h0][10:7];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_source = _RANDOM[5'h0][19:11];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM[5'h0][31:20], _RANDOM[5'h1][16:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = {_RANDOM[5'h1][31:17], _RANDOM[5'h2], _RANDOM[5'h3][16:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_data = {_RANDOM[5'h3][31:17], _RANDOM[5'h4], _RANDOM[5'h5], _RANDOM[5'h6], _RANDOM[5'h7], _RANDOM[5'h8], _RANDOM[5'h9], _RANDOM[5'hA], _RANDOM[5'hB], _RANDOM[5'hC], _RANDOM[5'hD], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10], _RANDOM[5'h11], _RANDOM[5'h12], _RANDOM[5'h13][16:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_corrupt = _RANDOM[5'h13][17];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
