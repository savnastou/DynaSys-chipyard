...
module TestHarness(
  ...
  wire        _source_1_clk;	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
  wire        _source_clk;	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:233:11]
    always @(posedge _source_1_clk) begin	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26, generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:233:11]
  ...
  ChipTop chiptop0 (	// @[generators/chipyard/src/main/scala/harness/HasHarnessInstantiators.scala:87:40]
    ...
    .reset_io                      (reset),
    .clock_uncore                  (_source_clk),	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
    .clock_tap                     (/* unused */),
    ...
    .serial_tl_0_clock_in          (_source_1_clk),	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
  ...
  UARTAdapter uart_sim_0_uartno0 (	// @[generators/testchipip/src/main/scala/uart/SimUART.scala:76:28]
    .clock       (_source_1_clk),	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
    .reset       (_harnessBinderReset_catcher_io_sync_reset),	// @[generators/rocket-chip/src/main/scala/util/ResetCatchAndSync.scala:39:28]
  ...
  ClockSourceAtFreqMHz #(
    .PERIOD(2.000000e+00)
  ) source (	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
  ...
  ClockSourceAtFreqMHz #(
    .PERIOD(1.000000e+01)
  ) source_1 (	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:69:26]
    .power (1'h1),	// @[generators/chipyard/src/main/scala/harness/HarnessBinders.scala:169:37]
    .gate  (1'h0),	// @[generators/chipyard/src/main/scala/harness/TestHarness.scala:23:25]
    .clk   (_source_1_clk)
  );
