...
module SimpleHellaCacheIFReplayQueue(
  ...
  wire        replay_complete = io_resp_valid & replaying & ~(|io_resp_bits_tag);	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:45:26, :63:40, :65:{52,72}]
  wire        nack_head = io_nack_valid & _nackq_io_deq_valid & ~(|io_nack_bits);	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:44:21, :62:40, :66:{55,71}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_inflight_T ? next_inflight_onehot : 2'h0)) & ~(io_resp_valid ? {~(|io_resp_bits_tag), ~(|io_resp_bits_tag)} & inflight : 2'h0);	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:21:14, :34:25, :63:{24,40,71}, :82:{25,30,72}, :83:{27,31}, src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/chisel3/util/Mux.scala:50:70]
  ...
  Queue_66 nackq (	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:44:21]
    ...
    .io_enq_bits  (~(|io_nack_bits) & inflight[1]),	// @[generators/rocket-chip/src/main/scala/rocket/SimpleHellaCacheIF.scala:34:25, :62:{40,67}, src/main/scala/chisel3/util/CircuitMath.scala:28:8]
