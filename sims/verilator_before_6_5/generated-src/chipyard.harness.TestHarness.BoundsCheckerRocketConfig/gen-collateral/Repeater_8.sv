...
module Repeater_8(
  ...
  input  [2:0]  io_enq_bits_size,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [2:0]  io_deq_bits_size,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM[1'h0][19:10];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM[1'h0][31:20], _RANDOM[1'h1][4:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[1'h1][12:5];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
