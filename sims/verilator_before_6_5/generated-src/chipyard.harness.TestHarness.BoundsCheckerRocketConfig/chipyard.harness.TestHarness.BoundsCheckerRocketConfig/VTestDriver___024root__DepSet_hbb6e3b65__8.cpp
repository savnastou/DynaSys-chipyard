...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__2252(VTestDriver___024root* vlSelf) {
    ...
    if (vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT___system_auto_cbus_fixedClockNode_out_reset) {
        ...
        if (vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__tile_prci_domain__DOT__element_reset_domain_rockettile__DOT__atomAddressMap__DOT__ctrl__DOT___GEN_11) {
