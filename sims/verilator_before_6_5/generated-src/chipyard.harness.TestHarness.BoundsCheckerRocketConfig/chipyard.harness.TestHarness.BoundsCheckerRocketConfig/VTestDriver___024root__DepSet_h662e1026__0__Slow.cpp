...
VL_ATTR_COLD void VTestDriver___024root___eval_initial__TOP__0(VTestDriver___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((VL_TESTPLUSARGS_I(VL_CVT_PACK_STR_NW(3, __Vtemp_3)) 
        ...
        VL_STOP_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.BoundsCheckerRocketConfig/gen-collateral/TestDriver.v", 98, "");
    }
