...
module tail_126x6(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
  input  [6:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [5:0] R0_data,
  ...
  reg [5:0] Memory[0:125];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
  ...
  assign R1_data = R1_en ? Memory[R1_addr] : 6'bx;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/ListBuffer.scala:48:18]
endmodule
