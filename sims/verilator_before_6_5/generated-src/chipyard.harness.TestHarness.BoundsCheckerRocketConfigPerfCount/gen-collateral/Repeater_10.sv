  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM[1'h0][31:20], _RANDOM[1'h1][8:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[1'h1][16:9];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
