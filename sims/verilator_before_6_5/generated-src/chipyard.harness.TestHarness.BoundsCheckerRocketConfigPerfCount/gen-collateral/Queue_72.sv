...
module Queue_72(
  ...
  ram_2x40 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_address, 6'h6, io_enq_bits_param})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_param = _ram_ext_R0_data[1:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_size = _ram_ext_R0_data[5:2];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_source = _ram_ext_R0_data[7:6];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[39:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
