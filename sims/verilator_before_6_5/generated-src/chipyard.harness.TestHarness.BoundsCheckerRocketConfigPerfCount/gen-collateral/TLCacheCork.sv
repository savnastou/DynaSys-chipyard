...
module TLCacheCork(
  ...
  wire [5:0]  _q_1_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
  ...
  wire [5:0]  _q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (idle & auto_out_a_ready)	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:61:28, :62:24]
        ...
        beatsLeft <= beatsLeft - {2'h0, auto_out_a_ready & nodeOut_a_valid};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :85:52, :96:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ...
      if (idle_1 & in_d_ready)	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:61:28, :62:24, generators/rocket-chip/src/main/scala/tilelink/CacheCork.scala:128:34]
        ...
        beatsLeft_1 <= beatsLeft_1 - {2'h0, _beatsLeft_T_4};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :85:52, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM[1'h0][2:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        nodeIn_d_bits_sink_r = _RANDOM[1'h0][5:3];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27, generators/rocket-chip/src/main/scala/util/package.scala:80:63]
        beatsLeft = _RANDOM[1'h1][17:15];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30]
        state_0 = _RANDOM[1'h1][18];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :88:26]
        state_1 = _RANDOM[1'h1][19];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :88:26]
        beatsLeft_1 = _RANDOM[1'h1][22:20];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30]
        state_1_0 = _RANDOM[1'h1][23];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :88:26]
        state_1_1 = _RANDOM[1'h1][24];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :88:26]
        state_1_2 = _RANDOM[1'h1][25];	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :88:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_d_bits_param = (muxState_1_1 ? _q_io_deq_bits_param : 2'h0) | (muxState_1_2 ? _q_1_io_deq_bits_param : 2'h0);	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_in_d_bits_size = _in_d_bits_WIRE_8;	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_in_d_bits_source = (muxState_1_0 ? auto_out_d_bits_source[6:1] : 6'h0) | (muxState_1_1 ? _q_io_deq_bits_source : 6'h0) | (muxState_1_2 ? _q_1_io_deq_bits_source : 6'h0);	// @[generators/rocket-chip/src/main/scala/diplomacy/Nodes.scala:1217:7, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/CacheCork.scala:135:46, src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_out_a_bits_source = (muxState_0 ? {auto_in_c_bits_source, 1'h0} : 7'h0) | (muxState_1 ? {auto_in_a_bits_source, _GEN | auto_in_a_bits_opcode == 3'h0 | auto_in_a_bits_opcode == 3'h1} : 7'h0);	// @[generators/rocket-chip/src/main/scala/diplomacy/Nodes.scala:1217:7, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/CacheCork.scala:68:{38,74}, :75:25, :78:{49,86}, :81:27, :96:41, src/main/scala/chisel3/util/Mux.scala:30:73]
