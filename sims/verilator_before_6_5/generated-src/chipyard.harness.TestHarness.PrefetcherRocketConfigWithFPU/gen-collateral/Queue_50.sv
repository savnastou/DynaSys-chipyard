...
module Queue_50(
  ...
  assign io_deq_bits_id = full ? ram[6:0] : io_enq_bits_id;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_addr = full ? ram[38:7] : io_enq_bits_addr;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_len = full ? ram[46:39] : io_enq_bits_len;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_size = full ? ram[49:47] : io_enq_bits_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_burst = full ? ram[51:50] : 2'h1;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_lock = full & ram[52];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_cache = full ? ram[56:53] : 4'h0;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_prot = full ? ram[59:57] : 3'h1;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_qos = full ? ram[63:60] : 4'h0;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_echo_tl_state_size = full ? ram[67:64] : io_enq_bits_echo_tl_state_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_echo_tl_state_source = full ? ram[74:68] : io_enq_bits_echo_tl_state_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_wen = full ? ram[75] : io_enq_bits_wen;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
endmodule
