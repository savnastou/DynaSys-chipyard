...
VL_INLINE_OPT void VTestDriver___024root___nba_sequent__TOP__4076(VTestDriver___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((((((1U != (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__system__DOT__tlDM__DOT__dmInner__DOT__dmInner__DOT__ctrlStateReg)) 
        ...
        VL_STOP_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.PrefetcherRocketConfigWithFPU/gen-collateral/TLDebugModuleInner.sv", 1041, "");
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->TestDriver__DOT__reset))))) {
            VL_WRITEF("[%0t] %%Fatal: TLDebugModuleInner.sv:1043: Assertion failed in %NTestDriver.testHarness.chiptop0.system.tlDM.dmInner.dmInner\n",
                      ...
                      vlSymsp->name());
            VL_STOP_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.PrefetcherRocketConfigWithFPU/gen-collateral/TLDebugModuleInner.sv", 1043, "");
        }
    }
    if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->TestDriver__DOT__testHarness__DOT__chiptop0__DOT__debug_reset)) 
        ...
        VL_WRITEF("[%0t] %%Error: TLDebugModuleInner.sv:1047: Assertion failed in %NTestDriver.testHarness.chiptop0.system.tlDM.dmInner.dmInner: Assertion failed: Unexpected EXCEPTION write: should only get it in Debug Module EXEC state\n    at Debug.scala:1840 assert ((!io.dmactive || !hartExceptionWrEn || ctrlStateReg === CtrlState(Exec)),\n\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.PrefetcherRocketConfigWithFPU/gen-collateral/TLDebugModuleInner.sv", 1047, "");
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->TestDriver__DOT__reset))))) {
            VL_WRITEF("[%0t] %%Fatal: TLDebugModuleInner.sv:1049: Assertion failed in %NTestDriver.testHarness.chiptop0.system.tlDM.dmInner.dmInner\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.PrefetcherRocketConfigWithFPU/gen-collateral/TLDebugModuleInner.sv", 1049, "");
        }
    }
}
    ...
    if ((1U & (~ (IData)(vlSelf->TestDriver__DOT__reset)))) {
        ...
        if (VL_UNLIKELY(vlSelf->TestDriver__DOT__failure)) {
            ...
            VL_WRITEF("[%0t] %%Fatal: TestDriver.v:147: Assertion failed in %NTestDriver\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.PrefetcherRocketConfigWithFPU/gen-collateral/TestDriver.v", 147, "");
        }
        if (VL_UNLIKELY(((1U == vlSelf->TestDriver__DOT__testHarness__DOT__success_exit_sim__DOT_____05Fexit_reg) 
            ...
            VL_FINISH_MT("/home/riscv/Documents/Chipyard/SavvinaThesis/chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.PrefetcherRocketConfigWithFPU/gen-collateral/TestDriver.v", 158, "");
        }
    }
}
