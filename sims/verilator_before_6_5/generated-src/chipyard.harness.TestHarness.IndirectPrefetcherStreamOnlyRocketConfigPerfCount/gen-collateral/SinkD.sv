...
module SinkD(
  ...
  output [5:0]  io_resp_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  input  [5:0]  io_d_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  output [5:0]  io_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14]
  ...
  wire [5:0]  _d_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
  ...
  reg  [5:0]  io_source_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:57:53]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][8:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:57:53, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][11:9];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:230:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
