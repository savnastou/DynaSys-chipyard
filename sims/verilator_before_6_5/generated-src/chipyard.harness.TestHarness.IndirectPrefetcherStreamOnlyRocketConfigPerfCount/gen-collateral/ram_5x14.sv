...
module ram_5x14(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [2:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [13:0] R0_data,
  ...
  reg [13:0] Memory[0:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[13:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
