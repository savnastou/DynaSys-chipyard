...
module IBuf(
  ...
  input         io_imem_valid,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
                io_imem_bits_btb_taken,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
                io_imem_bits_btb_bridx,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
  ...
  output        io_btb_resp_taken,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
  ...
  output [4:0]  io_inst_0_bits_inst_rd,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
                ...
                io_inst_0_bits_inst_rs3,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
  ...
  reg          ibufBTBResp_taken;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24]
  ...
  wire [1:0]   _nIC_T_2 = (io_imem_bits_btb_taken ? {1'h0, io_imem_bits_btb_bridx} + 2'h1 : 2'h2) - _GEN;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:34:47, :41:{16,64,86}, :92:63]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:79:9]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:79:9]
      if (~reset & ~(~io_imem_valid | ~io_imem_bits_btb_taken | io_imem_bits_btb_bridx >= io_imem_bits_pc[1])) begin	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:79:{9,10,28,52,78}, generators/rocket-chip/src/main/scala/util/package.scala:155:13]
  ...
  wire         _GEN_1 = _bufMask_T_1[0] & _exp_io_rvc | _bufMask_T_1[1];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:41:64, :75:37, :86:21, :100:{21,25,40,50}]
  ...
  wire         _GEN_2 = io_imem_valid & _nBufValid_T & _nICReady_T < _nIC_T_2 & ~(_nBufValid_T_6[1]);	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:41:86, :42:25, :44:{47,87,94}, :54:{62,68,75}]
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready & _GEN_2) begin	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13]
      ...
      ibufBTBResp_taken <= io_imem_bits_btb_taken;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_pc = {_RANDOM[3'h1][31:28], _RANDOM[3'h2], _RANDOM[3'h3][3:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_data = {_RANDOM[3'h3][31:4], _RANDOM[3'h4][3:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_pf_inst = _RANDOM[3'h4][6];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_gf_inst = _RANDOM[3'h4][7];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_ae_inst = _RANDOM[3'h4][8];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_replay = _RANDOM[3'h4][9];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        ibufBTBResp_taken = _RANDOM[3'h4][12];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :36:24]
        ibufBTBResp_entry = _RANDOM[3'h5][27:23];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24]
        ibufBTBResp_bht_history = {_RANDOM[3'h5][31:28], _RANDOM[3'h6][3:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_btb_resp_taken = _GEN_1 ? ibufBTBResp_taken : io_imem_bits_btb_taken;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24, :81:15, :100:{40,59,73}]
  assign io_btb_resp_entry = _GEN_1 ? ibufBTBResp_entry : io_imem_bits_btb_entry;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24, :81:15, :100:{40,59,73}]
  assign io_btb_resp_bht_history = _GEN_1 ? ibufBTBResp_bht_history : io_imem_bits_btb_bht_history;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:36:24, :81:15, :100:{40,59,73}]
