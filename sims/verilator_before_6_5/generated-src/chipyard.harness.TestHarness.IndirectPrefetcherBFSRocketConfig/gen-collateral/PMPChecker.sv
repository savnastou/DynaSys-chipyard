...
module PMPChecker(
  ...
  wire       res_aligned = io_pmp_7_cfg_a[1] ? (~(io_pmp_7_mask[2:0]) & res_aligned_lsbMask) == 3'h0 : ~((io_addr[31:3] ^ io_pmp_6_addr[29:1]) == 29'h0 & io_pmp_6_addr[0] & ~(io_addr[2]) | (io_addr[31:3] ^ io_pmp_7_addr[29:1]) == 29'h0 & io_pmp_7_addr[0] & (io_addr[2] | res_aligned_lsbMask[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:{28,55}, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_aligned_1 = io_pmp_6_cfg_a[1] ? (~(io_pmp_6_mask[2:0]) & res_aligned_lsbMask_1) == 3'h0 : ~((io_addr[31:3] ^ io_pmp_5_addr[29:1]) == 29'h0 & io_pmp_5_addr[0] & ~(io_addr[2]) | (io_addr[31:3] ^ io_pmp_6_addr[29:1]) == 29'h0 & io_pmp_6_addr[0] & (io_addr[2] | res_aligned_lsbMask_1[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_aligned_3 = io_pmp_4_cfg_a[1] ? (~(io_pmp_4_mask[2:0]) & res_aligned_lsbMask_3) == 3'h0 : ~((io_addr[31:3] ^ io_pmp_3_addr[29:1]) == 29'h0 & io_pmp_3_addr[0] & ~(io_addr[2]) | (io_addr[31:3] ^ io_pmp_4_addr[29:1]) == 29'h0 & io_pmp_4_addr[0] & (io_addr[2] | res_aligned_lsbMask_3[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_aligned_4 = io_pmp_3_cfg_a[1] ? (~(io_pmp_3_mask[2:0]) & res_aligned_lsbMask_4) == 3'h0 : ~((io_addr[31:3] ^ io_pmp_2_addr[29:1]) == 29'h0 & io_pmp_2_addr[0] & ~(io_addr[2]) | (io_addr[31:3] ^ io_pmp_3_addr[29:1]) == 29'h0 & io_pmp_3_addr[0] & (io_addr[2] | res_aligned_lsbMask_4[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_aligned_5 = io_pmp_2_cfg_a[1] ? (~(io_pmp_2_mask[2:0]) & res_aligned_lsbMask_5) == 3'h0 : ~((io_addr[31:3] ^ io_pmp_1_addr[29:1]) == 29'h0 & io_pmp_1_addr[0] & ~(io_addr[2]) | (io_addr[31:3] ^ io_pmp_2_addr[29:1]) == 29'h0 & io_pmp_2_addr[0] & (io_addr[2] | res_aligned_lsbMask_5[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
  ...
  wire       res_aligned_6 = io_pmp_1_cfg_a[1] ? (~(io_pmp_1_mask[2:0]) & res_aligned_lsbMask_6) == 3'h0 : ~((io_addr[31:3] ^ io_pmp_0_addr[29:1]) == 29'h0 & io_pmp_0_addr[0] & ~(io_addr[2]) | (io_addr[31:3] ^ io_pmp_1_addr[29:1]) == 29'h0 & io_pmp_1_addr[0] & (io_addr[2] | res_aligned_lsbMask_6[2]));	// @[generators/rocket-chip/src/main/scala/rocket/PMP.scala:45:20, :63:58, :69:29, :70:28, :82:64, :123:{49,67,82,90,127}, :124:{49,62,77,85,136}, :125:{24,46}, :126:{32,34,39,57}, :127:8, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71}]
