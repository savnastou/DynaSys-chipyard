...
module ram_data_3x512(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [1:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [511:0] Memory[0:2];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  `ifdef ENABLE_INITIAL_MEM_	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    reg [511:0] _RANDOM_MEM;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
