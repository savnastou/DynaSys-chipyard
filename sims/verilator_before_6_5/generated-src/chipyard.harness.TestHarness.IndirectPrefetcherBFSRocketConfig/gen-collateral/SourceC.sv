...
module SourceC(
  ...
  input  [5:0]  io_req_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  output [5:0]  io_c_bits_source,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14]
  ...
  reg  [5:0]  req_r_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
  ...
  reg  [5:0]  s2_req_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
  ...
  reg  [5:0]  s3_req_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_source = _RANDOM[2'h0][20:15];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_tag = {_RANDOM[2'h0][31:21], _RANDOM[2'h1][1:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47]
        req_r_set = _RANDOM[2'h1][11:2];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
        req_r_way = _RANDOM[2'h1][14:12];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47]
        s2_valid = _RANDOM[2'h1][16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :97:25]
        s2_req_opcode = _RANDOM[2'h1][19:17];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_param = _RANDOM[2'h1][22:20];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_source = _RANDOM[2'h1][28:23];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_tag = {_RANDOM[2'h1][31:29], _RANDOM[2'h2][9:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25]
        s2_req_set = _RANDOM[2'h2][19:10];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25]
        s3_valid = _RANDOM[2'h2][28];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :103:25]
        s3_req_opcode = _RANDOM[2'h2][31:29];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25]
        s3_req_param = _RANDOM[2'h3][2:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
        s3_req_source = _RANDOM[2'h3][8:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
        s3_req_tag = _RANDOM[2'h3][21:9];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
        s3_req_set = _RANDOM[2'h3][31:22];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
