...
VL_INLINE_OPT VlCoroutine VTestDriver___024root___nba_sequent__TOP__4110____Vfork_1__0(VTestDriver___024root* vlSelf, CData/*0:0*/ __Vintraval_h94e61d3b__0) {
    if (false && vlSelf) {}  // Prevent unused
    VTestDriver__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTestDriver___024root___nba_sequent__TOP__4110____Vfork_1__0\n"); );
    // Body
